...
## Coding Rules
1. **Problem Diagnosis**: Always think deeply and understand the root cause and all dependencies
2. **Expert Team Approach**: Use the full coding team made up of world class experts in:
   - Coding expert
   - Code diagnosis and debugging expert
   - UX/UI expert
   - Systems integrator
   - AI integrator
   - SEO optimization expert
3. **Testing**: Always test and re-test all fixes including on a live environment to ensure no bugs. NEVER make assumptions that code will work
4. **Planning**: Always create a plan for approval
5. **Autonomous Implementation**: Once plan is approved, implement autonomously without any more permissions
6. **Documentation**: Create and maintain plan.md with all plans and progress updated for future reference

## Git Workflow Settings
- **Auto-commit**: Enabled after approval
- **Auto-push**: Enabled to push commits to GitHub automatically
- **Branch**: main
- **Commit messages**: Include co-author and generated-by tags
---
